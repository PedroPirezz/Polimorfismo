O polimorfismo na programação tem como finalidade nomear uma classe multifuncional para simplificar o uso do código genérico, mantendo um melhor fluxo para aplicação de diversas ações variadas. 
